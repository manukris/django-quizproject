# Generated by Django 2.2.2 on 2019-07-03 02:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quizapp.QualifyDegree')),
                ('userid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quizapp.QuizUser')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='quizuser',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quizapp.UserNations'),
        ),
        migrations.AddField(
            model_name='quizuser',
            name='groups',
